...
Un cop instal·lades, activarem les eines d’administració necessàries ( Administració Bàsica de l’Active Directory)

Un cop activades les eines, obrim Usuaris i Equips de l’Active Directory i podrem **gestionar el domini** tal i com realitzaven amb Windows Server.
